...
let module Object = {
  ...
  external create:string => String.t = "Object" [@@bs.new]; 
  external create:T.t => T.t = "Object" [@@bs.new]; 
  external assign: Object$Assign.t = "" [@@bs.val];
  ...
  external entries: ('a => array TODO) = "" [@@bs.val];
  external freeze: (T.t => T.t) = "" [@@bs.val];
  external getOwnPropertyDescriptor: ('a => 'a => 'a) = "" [@@bs.val];
  external getOwnPropertyNames: ('a => array string) = "" [@@bs.val];
  external getOwnPropertySymbols: ('a => TODO) = "" [@@bs.val];
  external getPrototypeOf: Object$GetPrototypeOf.t = "" [@@bs.val];
  ...
  external valueOf: t => (unit => Object.t) = "" [@@bs.send];
};
...
let module Symbol = {
  type t;
  external create:value::(option 'a) => Symbol.t = "Symbol" [@@bs.new]; 
  external for: (string => Symbol.t) = "" [@@bs.val];
  external hasInstance: $SymbolHasInstance.t = "" [@@bs.val];
  external isConcatSpreadable: $SymboIsConcatSpreadable.t = "" [@@bs.val];
  external iterator: string = "" [@@bs.val];
  external keyFor: (Symbol.t => TODO) = "" [@@bs.val];
  let length = 0.;
  external match: $SymbolMatch.t = "" [@@bs.val];
  external replace: $SymbolReplace.t = "" [@@bs.val];
  external search: $SymbolSearch.t = "" [@@bs.val];
  external species: $SymbolSpecies.t = "" [@@bs.val];
  external split: $SymbolSplit.t = "" [@@bs.val];
  external toPrimitive: $SymbolToPrimitive.t = "" [@@bs.val];
  external toStringTag: $SymbolToStringTag.t = "" [@@bs.val];
  external unscopables: $SymbolUnscopables.t = "" [@@bs.val];
  external toString: t => (unit => string) = "" [@@bs.send];
...
let module Function = {
  ...
  external apply: t => Function$Prototype$Apply.t = "" [@@bs.get];
  external bind: t => Function$Prototype$Bind.t = "" [@@bs.get];
  external call: t => Function$Prototype$Call.t = "" [@@bs.get];
  external arguments: t => 'a = "" [@@bs.get];
  external caller: t => TODO = "" [@@bs.get];
...
let module Array = {
  type t;
  external create:array 'rest => array TODO = "Array" [@@bs.new]; 
  external _@@iterator: t => (unit => Iterator.t) = "" [@@bs.send];
  external toLocaleString: t => (unit => string) = "" [@@bs.send];
  external concat: t => (array 'rest => array TODO) = "" [@@bs.send] [@@bs.splice];
  external copyWithin: t => (float => float => end::(option float) => TODO) = "" [@@bs.send];
  external entries: t => (unit => Iterator.t) = "" [@@bs.send];
  external every: t => ((T.t => float => array TODO => 'a) => thisArg::(option 'a) => bool) = "" [@@bs.send];
  external fill: t => (T.t => begin::(option float) => end::(option float) => array TODO) = "" [@@bs.send];
  external filter: t => (TODO => array TODO) = "" [@@bs.send];
  external filter: t => ((T.t => float => array TODO => 'a) => thisArg::(option 'a) => array TODO) = "" [@@bs.send];
  external find: t => ((T.t => float => array TODO => 'a) => thisArg::(option 'a) => TODO) = "" [@@bs.send];
  external findIndex: t => ((T.t => float => array TODO => 'a) => thisArg::(option 'a) => float) = "" [@@bs.send];
  external forEach: t => ((T.t => float => array TODO => 'a) => thisArg::(option 'a) => unit) = "" [@@bs.send];
  external includes: t => (T.t => fromIndex::(option float) => bool) = "" [@@bs.send];
  external indexOf: t => (T.t => fromIndex::(option float) => float) = "" [@@bs.send];
  external join: t => (separator::(option string) => string) = "" [@@bs.send];
  external keys: t => (unit => Iterator.t) = "" [@@bs.send];
  external lastIndexOf: t => (T.t => fromIndex::(option float) => float) = "" [@@bs.send];
  external map: t => ((T.t => float => array TODO => U.t) => thisArg::(option 'a) => array TODO) = "" [@@bs.send];
  external pop: t => (unit => T.t) = "" [@@bs.send];
  external push: t => (array 'rest => float) = "" [@@bs.send] [@@bs.splice];
  external reduce: t => ((T.t => T.t => float => array TODO => T.t) => unit => T.t) = "" [@@bs.send];
  external reduce: t => ((U.t => T.t => float => array TODO => U.t) => U.t => U.t) = "" [@@bs.send];
  external reduceRight: t => ((T.t => T.t => float => array TODO => T.t) => unit => T.t) = "" [@@bs.send];
  external reduceRight: t => ((U.t => T.t => float => array TODO => U.t) => U.t => U.t) = "" [@@bs.send];
  external reverse: t => (unit => array TODO) = "" [@@bs.send];
  external shift: t => (unit => T.t) = "" [@@bs.send];
  external slice: t => (start::(option float) => end::(option float) => array TODO) = "" [@@bs.send];
  external some: t => ((T.t => float => array TODO => 'a) => thisArg::(option 'a) => bool) = "" [@@bs.send];
  external sort: t => (compareFn::(option (T.t => T.t => float)) => array TODO) = "" [@@bs.send];
  external splice: t => (float => deleteCount::(option float) => array 'rest => array TODO) = "" [@@bs.send] [@@bs.splice];
  ...
  external from: (Iterable.t => (A.t => float => B.t) => thisArg::(option 'a) => array TODO) = "" [@@bs.val];
  external from: (Iterable.t => unit => array TODO) = "" [@@bs.val];
  external from: (Iterator.t => (A.t => float => B.t) => thisArg::(option 'a) => array TODO) = "" [@@bs.val];
  external from: (Iterator.t => unit => array TODO) = "" [@@bs.val];
  external from: (TODO => (unit => float => A.t) => thisArg::(option 'a) => array TODO) = "" [@@bs.val];
  external from: (TODO => unit => array TODO) = "" [@@bs.val];
...
let module String = {
  ...
  external split: t => (TODO => limit::(option float) => array string) = "" [@@bs.send];
  ...
  external raw: ($Shape.t => array 'rest => string) = "" [@@bs.val] [@@bs.splice];
};
type TODO;
let module RegExp = {
  type t;
  external create:TODO => flags::(option RegExp$flags.t) => RegExp.t = "RegExp" [@@bs.new]; 
  external compile: t => (unit => RegExp.t) = "" [@@bs.send];
  external constructor: t => (TODO => flags::(option RegExp$flags.t) => RegExp.t) = "" [@@bs.send];
  ...
  external lastIndex: t => float = "" [@@bs.get];
...
let module Error = {
  type t;
  external create:message::(option string) => Error.t = "Error" [@@bs.new]; 
  external name: t => string = "" [@@bs.get];
  external message: t => string = "" [@@bs.get];
  external stack: t => string = "" [@@bs.get];
  external captureStackTrace: (Object.t => constructor::(option (unit => unit)) => unit) = "" [@@bs.val];
  external stackTraceLimit: float = "" [@@bs.val];
  external prepareStackTrace: (Error.t => TODO => 'a) = "" [@@bs.val];
};
...
let module $Iterator = {
  type t;
  external create: unit => t = "$Iterator" [@@bs.new]; 
  external _@@iterator: t => (unit => $Iterator.t) = "" [@@bs.send];
  external next: t => (value::(option Next.t) => IteratorResult.t) = "" [@@bs.send];
};
type TODO;
let module $Iterable = {
  type t;
  external create: unit => t = "$Iterable" [@@bs.new]; 
  external _@@iterator: t => (unit => $Iterator.t) = "" [@@bs.send];
};
type TODO;
let module Generator = {
  type t;
  external create: unit => t = "Generator" [@@bs.new]; 
  external _@@iterator: t => (unit => $Iterator.t) = "" [@@bs.send];
  external next: t => (value::(option Next.t) => IteratorResult.t) = "" [@@bs.send];
  external return: t => (R.t => TODO) = "" [@@bs.send];
  external throw: t => (error::(option 'a) => IteratorResult.t) = "" [@@bs.send];
};
let module Map = {
  type t;
  ...
  external delete: t => (K.t => bool) = "" [@@bs.send];
  external entries: t => (unit => Iterator.t) = "" [@@bs.send];
  external forEach: t => ((V.t => K.t => Map.t => 'a) => thisArg::(option 'a) => unit) = "" [@@bs.send];
  external get: t => (K.t => TODO) = "" [@@bs.send];
  external has: t => (K.t => bool) = "" [@@bs.send];
  external keys: t => (unit => Iterator.t) = "" [@@bs.send];
  external set: t => (K.t => V.t => Map.t) = "" [@@bs.send];
...
let module WeakMap = {
  ...
  external clear: t => (unit => unit) = "" [@@bs.send];
  external delete: t => (K.t => bool) = "" [@@bs.send];
  external get: t => (K.t => V.t) = "" [@@bs.send];
  external has: t => (K.t => bool) = "" [@@bs.send];
  external set: t => (K.t => V.t => WeakMap.t) = "" [@@bs.send];
};
let module Set = {
  type t;
  external create: unit => t = "Set" [@@bs.new]; 
  external _@@iterator: t => (unit => Iterator.t) = "" [@@bs.send];
  external add: t => (T.t => Set.t) = "" [@@bs.send];
  external clear: t => (unit => unit) = "" [@@bs.send];
  external delete: t => (T.t => bool) = "" [@@bs.send];
  external entries: t => (unit => Iterator.t) = "" [@@bs.send];
  external forEach: t => ((T.t => T.t => Set.t => 'a) => thisArg::(option 'a) => unit) = "" [@@bs.send];
  external has: t => (T.t => bool) = "" [@@bs.send];
  external keys: t => (unit => Iterator.t) = "" [@@bs.send];
  external size: t => float = "" [@@bs.get];
  external values: t => (unit => Iterator.t) = "" [@@bs.send];
};
let module WeakSet = {
  ...
  external constructor: t => (iterable::(option Iterable.t) => unit) = "" [@@bs.send];
  external add: t => (T.t => WeakSet.t) = "" [@@bs.send];
  external delete: t => (T.t => bool) = "" [@@bs.send];
  external has: t => (T.t => bool) = "" [@@bs.send];
};
let module Promise = {
  ...
  external then: t => (onFulfill::(option (R.t => TODO)) => onReject::(option ('a => TODO)) => Promise.t) = "" [@@bs.send];
  external catch: t => (onReject::(option ('a => TODO)) => Promise.t) = "" [@@bs.send];
  external resolve: (TODO => Promise.t) = "" [@@bs.val];
  external reject: (error::(option 'a) => Promise.t) = "" [@@bs.val];
  external all: Promise$All.t = "" [@@bs.val];
  external race: (array TODO => Promise.t) = "" [@@bs.val];
};
external _$await: (TODO => T.t) = "$await" [@@bs.val];
let module ArrayBuffer = {
  ...
  external byteLength: t => float = "" [@@bs.get];
  external slice: t => (float => end::(option float) => this.t) = "" [@@bs.send];
};
type TODO;
let module $TypedArray = {
  ...
  external from: (Iterable.t => this.t) = "" [@@bs.val];
  external of: (array 'rest => this.t) = "" [@@bs.val] [@@bs.splice];
  external constructor: t => (float => unit) = "" [@@bs.send];
  external constructor: t => ($TypedArray.t => unit) = "" [@@bs.send];
  external constructor: t => (Iterable.t => unit) = "" [@@bs.send];
  external constructor: t => (ArrayBuffer.t => byteOffset::(option float) => length::(option float) => unit) = "" [@@bs.send];
  external _@@iterator: t => (unit => Iterator.t) = "" [@@bs.send];
  external buffer: t => ArrayBuffer.t = "" [@@bs.get];
  external byteLength: t => float = "" [@@bs.get];
  external byteOffset: t => float = "" [@@bs.get];
  external length: t => float = "" [@@bs.get];
  external copyWithin: t => (float => float => end::(option float) => unit) = "" [@@bs.send];
  external entries: t => (unit => Iterator.t) = "" [@@bs.send];
  external every: t => ((float => float => this.t => 'a) => thisArg::(option 'a) => bool) = "" [@@bs.send];
  external fill: t => (float => start::(option float) => end::(option float) => unit) = "" [@@bs.send];
  external filter: t => ((float => float => this.t => 'a) => thisArg::(option 'a) => this.t) = "" [@@bs.send];
  external find: t => ((float => float => this.t => 'a) => thisArg::(option 'a) => TODO) = "" [@@bs.send];
  external findIndex: t => ((float => float => this.t => 'a) => thisArg::(option 'a) => TODO) = "" [@@bs.send];
  external forEach: t => ((float => float => this.t => 'a) => thisArg::(option 'a) => unit) = "" [@@bs.send];
  ...
  external join: t => (separator::(option string) => string) = "" [@@bs.send];
  external keys: t => (unit => array float) = "" [@@bs.send];
  external lastIndexOf: t => (float => fromIndex::(option float) => float) = "" [@@bs.send];
  external map: t => ((float => float => this.t => float) => thisArg::(option 'a) => this.t) = "" [@@bs.send];
  external reduce: t => ((float => float => float => this.t => float) => unit => float) = "" [@@bs.send];
  external reduce: t => ((U.t => float => float => this.t => U.t) => U.t => U.t) = "" [@@bs.send];
  external reduceRight: t => ((float => float => float => this.t => float) => unit => float) = "" [@@bs.send];
  external reduceRight: t => ((U.t => float => float => this.t => U.t) => U.t => U.t) = "" [@@bs.send];
  external reverse: t => (unit => this.t) = "" [@@bs.send];
  external set: t => (TODO => offset::(option float) => unit) = "" [@@bs.send];
  external slice: t => (begin::(option float) => end::(option float) => this.t) = "" [@@bs.send];
  external some: t => ((float => float => this.t => 'a) => thisArg::(option 'a) => bool) = "" [@@bs.send];
  external sort: t => (compare::(option (float => float => float)) => unit) = "" [@@bs.send];
  external subarray: t => (begin::(option float) => end::(option float) => this.t) = "" [@@bs.send];
  external values: t => (unit => Iterator.t) = "" [@@bs.send];
};
...
let module Reflect = {
  ...
  external apply: ((unit => unit) => thisArg::(option 'a) => argumentsList::(option array TODO) => 'a) = "" [@@bs.val];
  external construct: ((unit => unit) => argumentsList::(option array TODO) => newTarget::(option (unit => unit)) => 'a) = "" [@@bs.val];
  ...
  external isExtensible: ('a => bool) = "" [@@bs.val];
  external ownKeys: ('a => array TODO) = "" [@@bs.val];
...
let module Proxy = {
  ...
  external constructor: t => (T.t => Proxy$traps.t => T.t) = "" [@@bs.send];
  external revocable: (T.t => Proxy$traps.t => Proxy$revocable.t) = "" [@@bs.val];
};
...
let module Module = {
  ...
  external children: array TODO = "module.children" [@@bs.val];
};
